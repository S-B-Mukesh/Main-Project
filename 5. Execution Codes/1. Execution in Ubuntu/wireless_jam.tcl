...
set val(scene)			"scen_wireless_jam.tcl"
set val(conn)			"conn_wireless_jam.tcl"
set val(events)			"events_wireless_jam.tcl"
...
proc finish {} {
	global ns_ trace_fh argv0 val plot_fh 
	global ns_ trace_fh namtrace_fh
	$ns_ namtrace_fh
	$ns_ flush-trace
	close $namtrace_fh
	close $trace_fh
